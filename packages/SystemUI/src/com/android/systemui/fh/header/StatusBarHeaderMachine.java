...
package com.android.systemui.fh.header;
...
public class StatusBarHeaderMachine {
    ...
    public static final String STATUS_BAR_HEADER_UPDATE_ACTION = "com.android.systemui.fh.header.STATUS_BAR_HEADER_UPDATE";
