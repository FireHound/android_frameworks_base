...
class SaveImageInBackgroundTask extends AsyncTask<Void, Void, Void> {
    ...
    private static final String SPOOF_SCREENSHOT_FILE_NAME_TEMPLATE_APPNAME = "SpoofedImage_%s_%s.png";
    ...
    SaveImageInBackgroundTask(Context context, SaveImageInBackgroundData data,
        ...
        if (info != null) {
            ...
            if (appName != null) {
                ...
                mImageFileName = String.format(SPOOF_SCREENSHOT_FILE_NAME_TEMPLATE_APPNAME, appNameString, imageDate);
                } else {
                String appNameString = appName.toString().replaceAll("[\\\\/:*?\"<>|]", "_");
        ...
        mScreenshotDir = new File(Environment.getExternalStoragePublicDirectory(
                Environment.DIRECTORY_SPOOFED_IMAGES), SPOOF_SCREENSHOTS_DIR_NAME);
